...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages.add("Prof vai pagar o churras");
        messages.add("Breja  por conta do Prof");
        messages.add("Levar Prof para rodizio de pizza");
        messages.add("Ganhar nota do Prof");
